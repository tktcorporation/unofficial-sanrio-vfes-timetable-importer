...
export function SelectedSchedules({ selectedSchedules, onRemoveSchedule }: SelectedSchedulesProps) {
  if (selectedSchedules.size === 0) return null;

  return (
    <div className="mb-6 bg-white/80 backdrop-blur-sm rounded-lg shadow-lg p-4">
      <h2 className="text-lg font-semibold mb-3 text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-600">選択中の予定</h2>
